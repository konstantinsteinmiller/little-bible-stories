...
/**
 * Reusable achievement-badge presenter — mirrored from the main app so the
 * iPhone preview shows the same 3D tilt + alpha-shaped shine + drop-shadow
 * the player will see on the celebration page.
 *
